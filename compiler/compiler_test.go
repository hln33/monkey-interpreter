...
func TestCompilerScopes(t *testing.T) {
	...
	instructionsLen := len(compiler.scopes[compiler.scopeIndex].instructions)
	if instructionsLen != 1 {
	...
	instructionsLen = len(compiler.scopes[compiler.scopeIndex].instructions)
	if instructionsLen != 2 {
		t.Errorf("instructions length wrong. got=%d", instructionsLen)
	}
